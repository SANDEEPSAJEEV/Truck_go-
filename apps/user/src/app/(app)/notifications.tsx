  ...
  return (
    <Screen>
      <View style={styles.header}>
        <AppText variant="headlineLg">Notifications</AppText>
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', gap: Spacing.sm, paddingBottom: Spacing.md, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: Colors.outlineVariant },
